...
// تحقق مما إذا كان المستخدم قادمًا من طلب
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // If No Errors Send The Email [ mail(To, Subject, Message, Headers, Parameters) ]
             ...
             //   اذا لايوجد اخطاء في ارسال االايميل

        $headers = 'From: ' . $mail . '\r\n';
        $myEmail = 'Your Mail';   // ضع ايميلك المراد الإرسال إليه
        $subject = 'Contact Form'; // موضوع الرســـاله
...
<html lang="en">
    <head>
        ...
        <title>اساسيات برمجة الويب نموذج اتصل بنا </title>
